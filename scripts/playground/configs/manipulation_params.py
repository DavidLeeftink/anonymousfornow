...
def rsl_rl_config(env_name: str, unused_impl: Optional[str] = None) -> config_dict.ConfigDict:  # pylint: disable=unused-argument
  ...
  rl_config = config_dict.create(
      ...
      max_iterations=4_000,  # number of policy updates
      empirical_normalization=True,

      # logging
      save_interval=4_000,  # check for potential saves every this many iterations
  ...
  if env_name in ("LeapCubeReorient", "LeapCubeRotateZAxis"):
      rl_config.max_iterations = 4_000
      rl_config.num_minibatches = 32
      rl_config.num_steps_per_env = 40
