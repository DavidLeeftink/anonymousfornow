...
class RolloutStorage:
    ...
    class Transition:
        ...
        def __init__(self) -> None:
            ...
            # # For Neural Co-state Policy (and recurrent networks)
            # self.critic_hidden_state_derivative: torch.Tensor | None = None
            # """ Gradient of critic hidden state w.r.t. y (observation), for recurrent networks. """
    ...
    class Batch:
        ...
        def __init__(
            ...
            # critic_hidden_state_derivative: torch.Tensor = None,
